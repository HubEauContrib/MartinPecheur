...
| [ADR-008](adr/ADR-008-cqrs-leger-et-cache-en-pipeline.md) | CQRS léger, cache par décorateur de handler | Accepté |
| [ADR-009](adr/ADR-009-cible-windows.md) | Ajouter **Windows** aux cibles de la v1 | Accepté |
