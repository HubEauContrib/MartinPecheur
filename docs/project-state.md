...
| 44 | **Le contrôle « ⚠ Avertissement » est tronqué** en haut à droite (« Avertissemen… ») sur les captures du 2026-09-23, fenêtre ≈ 1 266 px, sous le ruban DEBUG | 🔄 À vérifier avec `K3` (taille minimale de fenêtre) — un avertissement ne se tronque jamais (`04-ui.md § 3`, `BR-012`) |
| 45 | **À 800 × 400, la légende de l'échelle écoulement (six lignes) recouvre la colonne des contrôles de zoom** — constaté par test le 2026-09-23 (`K1`, `map_view_test.dart`, test « CONSTAT »), sous la taille minimale de fenêtre proposée (800 × 600) | 🔄 À trancher avec `K3` : la taille minimale de fenêtre l'écarte, ou la disposition change. Le test verrouille le fait, pas un invariant désiré |
