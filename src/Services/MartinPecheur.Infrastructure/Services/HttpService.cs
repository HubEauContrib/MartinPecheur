using HubEauContrib.MartinPecheur.Infrastructure.Configurations;
...
namespace HubEauContrib.MartinPecheur.Infrastructure.Services;
...
public class HttpService
{
    ...
    public HttpService(HttpClient httpClient, IOptions<HubEauConfig> hubEauConfig)
    {
        _httpClient = httpClient;
        _apiUrl = hubEauConfig.Value.ApiBase;
    }
